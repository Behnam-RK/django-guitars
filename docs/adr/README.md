...
| [`0024`](0024-inverse-cascade-revive-rules.md) | why reviving a parent now revives the children that archive took, why the archive timestamp is the provenance test, and why the owned and self-referential families stay archive-only (2.13.0) |
