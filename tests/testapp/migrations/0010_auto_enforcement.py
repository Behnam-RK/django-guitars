# Generated by makeguitarmigrations command! [DIGEST:520e6d89051b9fb8cf115985a866059f]
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # Tenant RLS on "testapp_booking" table!
        migrations.RunSQL(
        ...
        # Tenant RLS on "testapp_release" table!
        migrations.RunSQL(
            sql=sql.create_table_rls(
        ...
        # Tenant RLS on "testapp_stadiumtour" table!
        migrations.RunSQL(
            sql=sql.create_table_rls(
        ...
        # Tenant RLS on "testapp_tour" table!
        migrations.RunSQL(
            sql=sql.create_table_rls(
        ...
        # Tenant RLS on "testapp_track" table!
        migrations.RunSQL(
            sql=sql.create_table_rls(
        ...
        # Tenant RLS on "testapp_worldtour" table!
        migrations.RunSQL(
            sql=sql.create_table_rls(
