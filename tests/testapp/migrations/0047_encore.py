    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('band', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='encores', to='testapp.band')),
            ],
            options={
                'abstract': False,
                'default_manager_name': 'objects',
                'indexes': [models.Index(condition=models.Q(('_deleted_at__isnull', True)), fields=['_deleted_at'], name='encore_deleted_at')],
            },
        ),
    ]
